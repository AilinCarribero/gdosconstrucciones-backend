...
insert into usuario (nombre_apellido, correo, contrasegna, id_rango) value ('Ailin Carribero','ailin@carribero.com.ar','contrasegna','1');
insert into usuario (nombre_apellido, correo, contrasegna, id_rango) value ('Rodrigo User','prueba@user.com','pruebauser','2');
insert into usuario (nombre_apellido, correo, contrasegna, id_rango) value ('Rodrigo Admin','prueba@admin.com','pruebaadmin','1');
...
/*-------------------------------------------------------------------------------------------------------------------------*/
/* Create new table */
create table proyecto (id_proyecto varchar primary key, id_unidad_negocio int, id_centro_costo int, id_cliente int, costo float, venta float, fecha_i_proyecto date, fecha_f_proyecto date, id_estado int;
...
/*-------------------------------------------------------------------------------------------------------------------------*/
/* Create new table */
create table egreso (id_egreso int auto_increment primary key, id_proyecto varchar(60), fecha_pago date, fecha_diferido_pago date, id_forma_pago int, id_user int, id_analisis_costo int, valor_pago float, cuota int, cuotas int, id_comprobante_pago int, numero_comprobante varchar, observaciones varchar(10000));
